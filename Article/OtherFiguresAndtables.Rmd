...
```{r}
# on récupère les labels des subjets pour calculer les LCP entre subjects and predictions
labels_P703 <- get_table_labels(test_data[1])
labels_P703$prop <- "P703"
labels_rP703 <- get_table_labels(test_data[2])
labels_rP703$prop <- "rP703"
...
```{r}
# On récupère les bales des objects pour pouvoir ensuite filtrer les prédictions sur des labels qui correspondent vraiments à des chemicals ou des organismes
