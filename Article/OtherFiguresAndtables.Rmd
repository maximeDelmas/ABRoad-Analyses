...
```{r}
topk <- 5
# Les top answers correspondent aux objets les plus frequement prédits par le modèle. On ne considère QUE les prédiction qui correspondent vraiment à des objects.. pas les "also" etc ...
...
manual_top_answers[topk:nrow(manual_top_answers), ]$avg_freq_in_preds <- (manual_top_answers[topk:nrow(manual_top_answers), ]$n * 100) / 500 
...
opti_top_answers[topk:nrow(manual_top_answers), ]$avg_freq_in_preds <- (opti_top_answers[topk:nrow(opti_top_answers), ]$n * 100) / (500 * 5) 
